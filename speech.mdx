...
iCendant Speech uses the same engine as iCendant Empathy but is not restricted to generating empathetic audio. For now you can preview its capability using [the same playground](https://icendant.com/empathy).
