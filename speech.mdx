...
At &dollar;0.008 per 1,000 characters, iCendant Speech is less than half the typical cost of Hume or Eleven Labs, 2x the speed of Hume and with comparable speed to ElevenLabs.
...
Review the API [documentation](/api-reference/speech/introduction).
...
iCendant Speech operates on a pre-paid credit system, where each credit is worth &dollar;0.001 USD. Every 1,000 characters consumes 8 credits. This means that 1,000 characters cost &dollar;0.008 USD.
...
Monthly subscriptions are required at either $25 or $50 per month, which include 1,000 or 2,500 credits respectively and should be adequate for testing. These charges include email support.
