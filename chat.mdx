...
Just add (206) 898-9507 to your contacts. Then start texting.
    ...
    - Chat memory is associated with your phone number, but you can clear it at any time
    - You can add @coach, @comic, and @poet to your chat by referencing them.

Or add emy@icendant.com to your contacts and start emailing.
    - Service is currently free, but may be rate limited.
    - Chat memory is constrained to a single email thread.
    - @coach, @comic, and @poet are not yet available.
