...
# iCendant Speech API - General Usage Documentation

## Overview

The iCendant Speech API converts text messages into natural-sounding speech with emotional nuance and prosodic control. 
...
Both API key and Account ID are required in headers for all requests:
